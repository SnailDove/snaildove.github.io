...
![img](http://img.blog.csdn.net/20180128173911805?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQveW91MTMxNDUyMG1l/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
![img](http://img.blog.csdn.net/20180128174503713?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQveW91MTMxNDUyMG1l/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
![img](http://img.blog.csdn.net/20150305085340825)
...
![img](http://img.blog.csdn.net/20150305085514798)

**注意：2种不同情况的调整的表达式都一样**

## 对于线性可分的数据集，PLA算法是可收敛的

![img](http://images.cnitblog.com/blog/115277/201312/03235523-d8e3f20d8b4348e2b4a6069abb9f1fb5.png)
...
![img](http://img.blog.csdn.net/20150423235711462)
...
![img](http://img.blog.csdn.net/20150423235300638)
...
![img](http://img.blog.csdn.net/20150424005455026)

再根据余弦值最大为1，可以得到$\frac{W_f^tW_t}{||W_f^t||\ ||W_t||}\le 1$，于是我们得到调整次数：$t\le \frac{||W_f^t||(max(||X||))^2}{(min(yW_f^tX))^2}={R^2 \over \rho^2}$.

## PLA的优缺点

![img](http://img.blog.csdn.net/20180128175157066?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQveW91MTMxNDUyMG1l/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
![img](http://img.blog.csdn.net/20180128175232900?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQveW91MTMxNDUyMG1l/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
