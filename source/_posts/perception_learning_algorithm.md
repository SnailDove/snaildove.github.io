...
![img](http://pltr89sz6.bkt.clouddn.com/gitpage/Hsuan-Tien_Lin/perception-learning-algorithm/1.png)
...
![img](http://pltr89sz6.bkt.clouddn.com/gitpage/Hsuan-Tien_Lin/perception-learning-algorithm/2.png)
...
![img](http://pltr89sz6.bkt.clouddn.com/gitpage/Hsuan-Tien_Lin/perception-learning-algorithm/3.png)
...
![img](http://pltr89sz6.bkt.clouddn.com/gitpage/Hsuan-Tien_Lin/perception-learning-algorithm/4.png)

**注意：2种不同情况的调整的表达式都一样**

## 对于线性可分的数据集，PLA算法是可收敛的

![img](http://pltr89sz6.bkt.clouddn.com/gitpage/Hsuan-Tien_Lin/perception-learning-algorithm/5.png)
...
![img](http://pltr89sz6.bkt.clouddn.com/gitpage/Hsuan-Tien_Lin/perception-learning-algorithm/6.png)
...
![img](http://pltr89sz6.bkt.clouddn.com/gitpage/Hsuan-Tien_Lin/perception-learning-algorithm/7.png)
...
![img](http://pltr89sz6.bkt.clouddn.com/gitpage/Hsuan-Tien_Lin/perception-learning-algorithm/8.png)

再根据余弦值最大为1，可以得到$\frac{W_f^tW_t}{||W_f^t||\ ||W_t||}\le 1$，于是我们得到调整次数：$t\le \frac{||W_f^t||(max(||X||))^2}{(min(yW_f^tX))^2}={R^2 \over \rho^2}$.

## PLA的优缺点

![img](http://pltr89sz6.bkt.clouddn.com/gitpage/Hsuan-Tien_Lin/perception-learning-algorithm/9.png)
...
![img](http://pltr89sz6.bkt.clouddn.com/gitpage/Hsuan-Tien_Lin/perception-learning-algorithm/10.png)
