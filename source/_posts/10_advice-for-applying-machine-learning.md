...
![img](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/10/1.png)

The training error will tend to **decrease** as we increase the degree d of the polynomial. 

At the same time, the cross validation error will tend to **decrease** as we increase d up to a point, and then it will **increase** as d is increased, forming a convex curve. 

![high_bias_and_high_variance](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/10/2.png)
...
![img](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/10/3.png)
...
![3_kinds_of_Linear_regression_with_regularization](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/10/4.png)

![img](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/10/5.png)
...
![img](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/10/6.png)
...
![high_bias_on_training_size](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/10/7.png)
...
![high_variance_on_training_size](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/10/8.png)
...
![Neural_networks_and_overfitting](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/10/9.png)
