...
![img](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/09/1.png)
...
![backpropagation_algorithm](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/09/2.png)
...
![forward_propagation](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/09/3.png)
...
Recall that our derivative is the slope of a line tangent to the cost function, so the steeper the slope the more incorrect we are. Let us consider the following neural network below and see how we could calculate some $\delta_j^{(l)}$: 
 ...
 ![backward propagation intuition1](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/09/4.png)
...
![neural_network_learning_theta](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/09/5.png)
...
![random_initialization_on_nn](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/09/6.png)
...
![](http://pkaunwk1s.bkt.clouddn.com/gitpage/ml-andrew-ng/09/7.png)
