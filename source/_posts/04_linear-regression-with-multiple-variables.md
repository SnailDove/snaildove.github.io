...
![gradient_descent_with_multiple_variables](http://pne0wr4lu.bkt.clouddn.com/gitpage/ml-andrew-ng/04/gradient_descent_with_multiple_variables.png)
...
![why_feature_scale](http://pne0wr4lu.bkt.clouddn.com/gitpage/ml-andrew-ng/04/why_feature_scale.png)
...
![making_sure_gradient_descent_is_working_correctly](http://pne0wr4lu.bkt.clouddn.com/gitpage/ml-andrew-ng/04/making_sure_gradient_descent_is_working_correctly.png)

It has been proven that if learning rate $α$ is sufficiently small, then $J(θ)$ will decrease on every iteration.

![2_making_sure_gradient_descent_is_working_correctly](http://pne0wr4lu.bkt.clouddn.com/gitpage/ml-andrew-ng/04/2_making_sure_gradient_descent_is_working_correctly.png)
...
![example_of_polynomial_regression](http://pne0wr4lu.bkt.clouddn.com/gitpage/ml-andrew-ng/04/example_of_polynomial_regression.png)
...
\theta = (X^T X)^{-1}X^T y
$$
![example_of_normal_equation](http://pne0wr4lu.bkt.clouddn.com/gitpage/ml-andrew-ng/04/construction_of_normal_equation.png)

![construction_of_normal_equation](http://pne0wr4lu.bkt.clouddn.com/gitpage/ml-andrew-ng/04/construction_of_normal_equation.png)
...
![solution_of_normal_equation_with_non-invertible_X^TX](http://pne0wr4lu.bkt.clouddn.com/gitpage/ml-andrew-ng/04/solution_of_normal_equation_with_non-invertible_X%5ETX.png)
