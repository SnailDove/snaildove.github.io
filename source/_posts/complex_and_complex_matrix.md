...
![1st_notations_of_FFT](http://pkaunwk1s.bkt.clouddn.com/gitpage/tsinghua_linear_algebra/2-12/1.png)

将$A_0, A_1, A_2, A_3$重新排序$A_0,A_2,A_1,A_3$使用记号，则

![2nd_notations_of_FFT](http://pkaunwk1s.bkt.clouddn.com/gitpage/tsinghua_linear_algebra/2-12/2.png)
...
![1st_example_of_reordering_of_FFT](http://pkaunwk1s.bkt.clouddn.com/gitpage/tsinghua_linear_algebra/2-12/3.png)
...
![3rd_butterfly_operation_of_FFT](http://pkaunwk1s.bkt.clouddn.com/gitpage/tsinghua_linear_algebra/2-12/4.png)
...
![4th_butterfly_operation_of_FFT](http://pkaunwk1s.bkt.clouddn.com/gitpage/tsinghua_linear_algebra/2-12/5.png)

不停的划分下去，即：$FFT$算法将$DFT$算法分成$log_2^N$段，每一段有${N\over 2}$个butterfly operation。

举例：

![](http://pkaunwk1s.bkt.clouddn.com/gitpage/tsinghua_linear_algebra/2-12/6.png)
